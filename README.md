...
- [1.1. Networking and Web Fundamentals](images/1.1_Networking_and_Web_Fundamentals) — ![](images/1.1_Networking_and_Web_Fundamentals/Networking_and_Web_Fundamentals.jpeg)
- [1.2. Web Sockets + Authentication & Security](images/1.2_Web_Sockets_Authentication_and_Security) — ![](images/1.2_Web_Sockets_Authentication_and_Security/WebSockets.jpeg)
- [1.3. Token Based Auth & Rate Limiting](images/1.3_Token_Based_Auth_and_Rate_Limiting) — ![](images/1.3_Token_Based_Auth_and_Rate_Limiting/Token_Based_Auth.jpeg)
- [1.4. Prompt Injection & PII Masking](images/1.4_Prompt_Injection_and_PII_Masking) — ![](images/1.4_Prompt_Injection_and_PII_Masking/Prompt_Injection.jpeg)
- [1.5. MCP Tool Authorisation](images/1.5_MCP_Tool_Authorisation) — ![](images/1.5_MCP_Tool_Authorisation/MCP_Tool_Authorisation.jpeg)

### Databases

- [2.1. Database Fundamentals](images/2.1_Database_Fundamentals) — ![](images/2.1_Database_Fundamentals/Database_and_Storage_Fundamentals.jpeg)
- [2.2. Indexes, Query Optimisation, Normalisation & Denormalisation](images/2.2_Indexes_Query_Optimisation_Normalisation_and_Denormalisation) — ![](images/2.2_Indexes_Query_Optimisation_Normalisation_and_Denormalisation/Database_Optimisation.jpeg)
- [2.3. Bloom Filter & Location Based Databases](images/2.3_Bloom_Filter_and_Location_Based_Databases) — ![](images/2.3_Bloom_Filter_and_Location_Based_Databases/Bloom_Filters.jpeg)
- [2.4. Sharding & Replication](images/2.4_Sharding_and_Replication) — ![](images/2.4_Sharding_and_Replication/Distributed_Databases.jpeg)
- [2.5. DB Migration, Connection Pooling & NoSQL Optimisation](images/2.5_DB_Migration_Connection_Pooling_and_NoSQL_Optimisation) — ![](images/2.5_DB_Migration_Connection_Pooling_and_NoSQL_Optimisation/DB_Migration.jpeg)

### Vector DB & Search

- [3. Vector DB, Metadata Filtering & Hybrid Search](images/3_Vector_DB_Metadata_Filtering_and_Hybrid_Search) — ![](images/3_Vector_DB_Metadata_Filtering_and_Hybrid_Search/AI_Specific_Storage.jpeg)

### Caching

- [4.1. Caching, Types of Caching, Redis and CDN](images/4.1_Caching_Types_of_Caching_Redis_and_CDN) — ![](images/4.1_Caching_Types_of_Caching_Redis_and_CDN/Caching.jpeg)
- [4.2. Distributed Caching, Cache Replacement Policies, Thrashing, AI Based Caching](images/4.2_Distributed_Caching_Cache_Replacement_Policies_and_AI_Caching) — ![](images/4.2_Distributed_Caching_Cache_Replacement_Policies_and_AI_Caching/Distributed_Caching.jpeg)

### System Design & Architecture

- [5.1. System Design](images/5.1_System_Design) — ![](images/5.1_System_Design/System_Design.jpeg)
- [5.2. Monolith vs Microservices](images/5.2_Monolith_vs_Microservices) — ![](images/5.2_Monolith_vs_Microservices/Monolith_vs_Microservices.jpeg)
- [5.3. Scaling, Load Balancing, Capacity Estimation, Consistent Hashing](images/5.3_Scaling_Load_Balancing_Capacity_Estimation_Consistent_Hashing) — ![](images/5.3_Scaling_Load_Balancing_Capacity_Estimation_Consistent_Hashing/Scaling.jpeg)
